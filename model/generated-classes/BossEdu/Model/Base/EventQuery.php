 ...
 * 
 *
 * @method     ChildEventQuery orderByCode($order = Criteria::ASC) Order by the code column
 * @method     ChildEventQuery orderByName($order = Criteria::ASC) Order by the name column
 * @method     ChildEventQuery orderByWorkload($order = Criteria::ASC) Order by the workload column
 *
 * @method     ChildEventQuery groupByCode() Group by the code column
 * @method     ChildEventQuery groupByName() Group by the name column
 * @method     ChildEventQuery groupByWorkload() Group by the workload column
 *
 ...
 *
 * @method     ChildEventQuery leftJoinElHave($relationAlias = null) Adds a LEFT JOIN clause to the query using the ElHave relation
 * @method     ChildEventQuery rightJoinElHave($relationAlias = null) Adds a RIGHT JOIN clause to the query using the ElHave relation
 * @method     ChildEventQuery innerJoinElHave($relationAlias = null) Adds a INNER JOIN clause to the query using the ElHave relation
 *
 * @method     ChildEventQuery joinWithElHave($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the ElHave relation
 *
 * @method     ChildEventQuery leftJoinWithElHave() Adds a LEFT JOIN clause and with to the query using the ElHave relation
 * @method     ChildEventQuery rightJoinWithElHave() Adds a RIGHT JOIN clause and with to the query using the ElHave relation
 * @method     ChildEventQuery innerJoinWithElHave() Adds a INNER JOIN clause and with to the query using the ElHave relation
 *
 ...
 *
 * @method     ChildEvent findOneByCode(string $code) Return the first ChildEvent filtered by the code column
 * @method     ChildEvent findOneByName(string $name) Return the first ChildEvent filtered by the name column
 * @method     ChildEvent findOneByWorkload(string $workload) Return the first ChildEvent filtered by the workload column *
 ...
 *
 * @method     ChildEvent requireOneByCode(string $code) Return the first ChildEvent filtered by the code column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildEvent requireOneByWorkload(string $workload) Return the first ChildEvent filtered by the workload column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildEvent[]|ObjectCollection findByCode(string $code) Return ChildEvent objects filtered by the code column
 * @method     ChildEvent[]|ObjectCollection findByName(string $name) Return ChildEvent objects filtered by the name column
 * @method     ChildEvent[]|ObjectCollection findByWorkload(string $workload) Return ChildEvent objects filtered by the workload column
...
abstract class EventQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \BossEdu\Model\Base\EventQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\BossEdu\\Model\\Event', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT code, name, workload FROM event WHERE code = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(EventTableMap::COL_CODE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(EventTableMap::COL_CODE, $keys, Criteria::IN);
    }
    ...
    public function filterByCode($code = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(EventTableMap::COL_CODE, $code, $comparison);
    }
    ...
    public function filterByWorkload($workload = null, $comparison = null)
    {
        if (is_array($workload)) {
            ...
            if (isset($workload['min'])) {
                $this->addUsingAlias(EventTableMap::COL_WORKLOAD, $workload['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($workload['max'])) {
                $this->addUsingAlias(EventTableMap::COL_WORKLOAD, $workload['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(EventTableMap::COL_WORKLOAD, $workload, $comparison);
    }
    ...
    public function filterByElHave($elHave, $comparison = null)
    {
        if ($elHave instanceof \BossEdu\Model\ElHave) {
            return $this
                ->addUsingAlias(EventTableMap::COL_CODE, $elHave->getEventCode(), $comparison);
    ...
    {
        if ($event) {
            $this->addUsingAlias(EventTableMap::COL_CODE, $event->getCode(), Criteria::NOT_EQUAL);
        }
