...
/**
 * Base class that represents a row from the 'lecture' table.
 *
 * 
 *
* @package    propel.generator.BossEdu.Model.Base
*/
abstract class Lecture implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\BossEdu\\Model\\Map\\LectureTableMap';
    ...
    /**
     * Initializes internal state of BossEdu\Model\Base\Lecture object.
     */
    ...
    /**
     * Compares this with another <code>Lecture</code> instance.  If
     * <code>obj</code> is an instance of <code>Lecture</code>, delegates to
     * <code>equals(Lecture)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Lecture The current object, for fluid interface
     */
     ...
     * @return $this|\BossEdu\Model\Lecture The current object (for fluent API support)
     */
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[LectureTableMap::COL_CODE] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[LectureTableMap::COL_NAME] = true;
        }
    ...
    public function setWorkload($v)
    {
        ...
        if ($this->workload !== $v) {
            $this->workload = $v;
            $this->modifiedColumns[LectureTableMap::COL_WORKLOAD] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : LectureTableMap::translateFieldName('Code', TableMap::TYPE_PHPNAME, $indexType)];
            $this->code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : LectureTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : LectureTableMap::translateFieldName('Workload', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = LectureTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\BossEdu\\Model\\Lecture'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildLectureQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Lecture::setDeleted()
     * @see Lecture::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildLectureQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LectureTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(LectureTableMap::COL_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'code';
        }
        if ($this->isColumnModified(LectureTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(LectureTableMap::COL_WORKLOAD)) {
            $modifiedColumns[':p' . $index++]  = 'workload';
        }

        $sql = sprintf(
            'INSERT INTO lecture (%s) VALUES (%s)',
    ...
    {
        $pos = LectureTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Lecture'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Lecture'][$this->hashCode()] = true;
        $keys = LectureTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getCode(),
            $keys[1] => $this->getName(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\BossEdu\Model\Lecture
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\BossEdu\Model\Lecture The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(LectureTableMap::DATABASE_NAME);

        if ($this->isColumnModified(LectureTableMap::COL_CODE)) {
            $criteria->add(LectureTableMap::COL_CODE, $this->code);
        }
        if ($this->isColumnModified(LectureTableMap::COL_NAME)) {
            $criteria->add(LectureTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(LectureTableMap::COL_WORKLOAD)) {
            $criteria->add(LectureTableMap::COL_WORKLOAD, $this->workload);
        }
    ...
    {
        $criteria = ChildLectureQuery::create();
        $criteria->add(LectureTableMap::COL_CODE, $this->code);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \BossEdu\Model\Lecture (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \BossEdu\Model\Lecture Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildLecture is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildLecture The current object (for fluent API support)
     */
     ...
     * Otherwise if this Lecture is new, it will return
     * an empty collection; or if this Lecture has previously
     * been saved, it will retrieve related ElHaves from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Lecture.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildElHave[] List of ChildElHave objects
     */
    public function getElHavesJoinEvent(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildElHaveQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(LectureTableMap::DEFAULT_STRING_FORMAT);
    }
