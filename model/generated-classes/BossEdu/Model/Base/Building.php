...
/**
 * Base class that represents a row from the 'building' table.
 *
 * 
 *
* @package    propel.generator.BossEdu.Model.Base
*/
abstract class Building implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\BossEdu\\Model\\Map\\BuildingTableMap';
    ...
    /**
     * Initializes internal state of BossEdu\Model\Base\Building object.
     */
    ...
    /**
     * Compares this with another <code>Building</code> instance.  If
     * <code>obj</code> is an instance of <code>Building</code>, delegates to
     * <code>equals(Building)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Building The current object, for fluid interface
     */
     ...
     * @return $this|\BossEdu\Model\Building The current object (for fluent API support)
     */
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[BuildingTableMap::COL_CODE] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[BuildingTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : BuildingTableMap::translateFieldName('Code', TableMap::TYPE_PHPNAME, $indexType)];
            $this->code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : BuildingTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = BuildingTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\BossEdu\\Model\\Building'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildBuildingQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Building::setDeleted()
     * @see Building::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildBuildingQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BuildingTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->roomsScheduledForDeletion !== null) {
                if (!$this->roomsScheduledForDeletion->isEmpty()) {
                    \BossEdu\Model\RoomQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(BuildingTableMap::COL_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'code';
        }
        if ($this->isColumnModified(BuildingTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }

        $sql = sprintf(
            'INSERT INTO building (%s) VALUES (%s)',
    ...
    {
        $pos = BuildingTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Building'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Building'][$this->hashCode()] = true;
        $keys = BuildingTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getCode(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\BossEdu\Model\Building
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\BossEdu\Model\Building The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(BuildingTableMap::DATABASE_NAME);

        if ($this->isColumnModified(BuildingTableMap::COL_CODE)) {
            $criteria->add(BuildingTableMap::COL_CODE, $this->code);
        }
        if ($this->isColumnModified(BuildingTableMap::COL_DESCRIPTION)) {
            $criteria->add(BuildingTableMap::COL_DESCRIPTION, $this->description);
        }
    ...
    {
        $criteria = ChildBuildingQuery::create();
        $criteria->add(BuildingTableMap::COL_CODE, $this->code);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \BossEdu\Model\Building (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \BossEdu\Model\Building Clone of current object.
     * @throws PropelException
     */
    ...
    public function initRooms($overrideExisting = true)
    {
        ...
        $collectionClassName = RoomTableMap::getTableMap()->getCollectionClassName();

        $this->collRooms = new $collectionClassName;
        $this->collRooms->setModel('\BossEdu\Model\Room');
    }
     ...
     * If this ChildBuilding is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildBuilding The current object (for fluent API support)
     */
    ...
    public function addRoom(ChildRoom $l)
    {
        ...
        if (!$this->collRooms->contains($l)) {
            ...
            if ($this->roomsScheduledForDeletion and $this->roomsScheduledForDeletion->contains($l)) {
                $this->roomsScheduledForDeletion->remove($this->roomsScheduledForDeletion->search($l));
            }
        }
    ...
    {
        return (string) $this->exportTo(BuildingTableMap::DEFAULT_STRING_FORMAT);
    }
