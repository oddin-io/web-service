...
/**
 * Base class that represents a row from the 'pi_link' table.
 *
 * 
 *
* @package    propel.generator.BossEdu.Model.Base
*/
abstract class PiLink implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\BossEdu\\Model\\Map\\PiLinkTableMap';
    ...
    /**
     * Initializes internal state of BossEdu\Model\Base\PiLink object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>PiLink</code> instance.  If
     * <code>obj</code> is an instance of <code>PiLink</code>, delegates to
     * <code>equals(PiLink)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|PiLink The current object, for fluid interface
     */
     ...
     * @return $this|\BossEdu\Model\PiLink The current object (for fluent API support)
     */
    public function setInstructionId($v)
    {
        ...
        if ($this->instruction_id !== $v) {
            ...
            $this->modifiedColumns[PiLinkTableMap::COL_INSTRUCTION_ID] = true;
        }
    ...
    public function setPersonId($v)
    {
        ...
        if ($this->person_id !== $v) {
            $this->person_id = $v;
            $this->modifiedColumns[PiLinkTableMap::COL_PERSON_ID] = true;
        }
    ...
    public function setProfile($v)
    {
        ...
        if ($this->profile !== $v) {
            $this->profile = $v;
            $this->modifiedColumns[PiLinkTableMap::COL_PROFILE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PiLinkTableMap::translateFieldName('InstructionId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->instruction_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PiLinkTableMap::translateFieldName('PersonId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->person_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PiLinkTableMap::translateFieldName('Profile', TableMap::TYPE_PHPNAME, $indexType)];
            $this->profile = (null !== $col) ? (int) $col : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = PiLinkTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\BossEdu\\Model\\PiLink'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPiLinkQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see PiLink::setDeleted()
     * @see PiLink::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPiLinkQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PiLinkTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PiLinkTableMap::COL_INSTRUCTION_ID)) {
            $modifiedColumns[':p' . $index++]  = 'instruction_id';
        }
        if ($this->isColumnModified(PiLinkTableMap::COL_PERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = 'person_id';
        }
        if ($this->isColumnModified(PiLinkTableMap::COL_PROFILE)) {
            $modifiedColumns[':p' . $index++]  = 'profile';
        }

        $sql = sprintf(
            'INSERT INTO pi_link (%s) VALUES (%s)',
    ...
    {
        $pos = PiLinkTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['PiLink'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PiLink'][$this->hashCode()] = true;
        $keys = PiLinkTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\BossEdu\Model\PiLink
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\BossEdu\Model\PiLink The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PiLinkTableMap::COL_INSTRUCTION_ID)) {
            $criteria->add(PiLinkTableMap::COL_INSTRUCTION_ID, $this->instruction_id);
        }
        if ($this->isColumnModified(PiLinkTableMap::COL_PERSON_ID)) {
            $criteria->add(PiLinkTableMap::COL_PERSON_ID, $this->person_id);
        }
        if ($this->isColumnModified(PiLinkTableMap::COL_PROFILE)) {
            $criteria->add(PiLinkTableMap::COL_PROFILE, $this->profile);
        }
    ...
    {
        $criteria = ChildPiLinkQuery::create();
        $criteria->add(PiLinkTableMap::COL_INSTRUCTION_ID, $this->instruction_id);
        $criteria->add(PiLinkTableMap::COL_PERSON_ID, $this->person_id);
    ...
    public function hashCode()
    {
        ...
        //relation pi_link_instruction_fk to table instruction
        ...
        //relation pi_link_person_fk to table person
    ...
    {
        return (null === $this->getInstructionId()) && (null === $this->getPersonId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \BossEdu\Model\PiLink (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \BossEdu\Model\PiLink Clone of current object.
     * @throws PropelException
     */
    ...
    public function getInstruction(ConnectionInterface $con = null)
    {
        if ($this->aInstruction === null && ($this->instruction_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aInstruction->addPiLinks($this);
             */
        }
    ...
    {
        if (null !== $this->aInstruction) {
            $this->aInstruction->removePiLink($this);
        }
        if (null !== $this->aPerson) {
            $this->aPerson->removePiLink($this);
        }
    ...
    {
        return (string) $this->exportTo(PiLinkTableMap::DEFAULT_STRING_FORMAT);
    }
