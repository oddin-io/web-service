...
/**
 * Base class that represents a row from the 'someone' table.
 *
 * 
 *
* @package    propel.generator.BossEdu.Model.Base
*/
abstract class Someone implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\BossEdu\\Model\\Map\\SomeoneTableMap';
    ...
    /**
     * Initializes internal state of BossEdu\Model\Base\Someone object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>Someone</code> instance.  If
     * <code>obj</code> is an instance of <code>Someone</code>, delegates to
     * <code>equals(Someone)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Someone The current object, for fluid interface
     */
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[SomeoneTableMap::COL_EMAIL] = true;
        }
    ...
    public function setPassword($v)
    {
        ...
        if ($this->password !== $v) {
            $this->password = $v;
            $this->modifiedColumns[SomeoneTableMap::COL_PASSWORD] = true;
        }
    ...
    public function setAdmin($v)
    {
        ...
        if ($this->admin !== $v) {
            $this->admin = $v;
            $this->modifiedColumns[SomeoneTableMap::COL_ADMIN] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SomeoneTableMap::translateFieldName('Email', TableMap::TYPE_PHPNAME, $indexType)];
            $this->email = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SomeoneTableMap::translateFieldName('Password', TableMap::TYPE_PHPNAME, $indexType)];
            $this->password = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SomeoneTableMap::translateFieldName('RegistrationDate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->registration_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SomeoneTableMap::translateFieldName('Admin', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = SomeoneTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\BossEdu\\Model\\Someone'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSomeoneQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Someone::setDeleted()
     * @see Someone::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSomeoneQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SomeoneTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->peopleScheduledForDeletion !== null) {
                if (!$this->peopleScheduledForDeletion->isEmpty()) {
                    \BossEdu\Model\PersonQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SomeoneTableMap::COL_EMAIL)) {
            $modifiedColumns[':p' . $index++]  = 'email';
        }
        if ($this->isColumnModified(SomeoneTableMap::COL_PASSWORD)) {
            $modifiedColumns[':p' . $index++]  = 'password';
        }
        if ($this->isColumnModified(SomeoneTableMap::COL_REGISTRATION_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'registration_date';
        }
        if ($this->isColumnModified(SomeoneTableMap::COL_ADMIN)) {
            $modifiedColumns[':p' . $index++]  = 'admin';
        }

        $sql = sprintf(
            'INSERT INTO someone (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'registration_date':                        
                        $stmt->bindValue($identifier, $this->registration_date ? $this->registration_date->format("Y-m-d H:i:s") : null, PDO::PARAM_STR);
                        break;
                    case 'admin':                        
    ...
    {
        $pos = SomeoneTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Someone'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Someone'][$this->hashCode()] = true;
        $keys = SomeoneTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getEmail(),
            $keys[1] => $this->getPassword(),
            $keys[2] => $this->getRegistrationDate(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\BossEdu\Model\Someone
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setRegistrationDate($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setAdmin($arr[$keys[3]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\BossEdu\Model\Someone The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SomeoneTableMap::COL_EMAIL)) {
            $criteria->add(SomeoneTableMap::COL_EMAIL, $this->email);
        }
        if ($this->isColumnModified(SomeoneTableMap::COL_PASSWORD)) {
            $criteria->add(SomeoneTableMap::COL_PASSWORD, $this->password);
        }
        if ($this->isColumnModified(SomeoneTableMap::COL_REGISTRATION_DATE)) {
            $criteria->add(SomeoneTableMap::COL_REGISTRATION_DATE, $this->registration_date);
        }
        if ($this->isColumnModified(SomeoneTableMap::COL_ADMIN)) {
            $criteria->add(SomeoneTableMap::COL_ADMIN, $this->admin);
        }
    ...
    {
        $criteria = ChildSomeoneQuery::create();
        $criteria->add(SomeoneTableMap::COL_EMAIL, $this->email);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \BossEdu\Model\Someone (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \BossEdu\Model\Someone Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildSomeone is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSomeone The current object (for fluent API support)
     */
    ...
    {
        return (string) $this->exportTo(SomeoneTableMap::DEFAULT_STRING_FORMAT);
    }
