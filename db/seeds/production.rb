...
thon_ataide = Person.create name: 'Thon Christopher Ataide', email: 'thom_ataide10@hotmail.com', password: '150102X'
willian_correa = Person.create name: 'Willian Toshio Nogiri Correa', email: 'willianthoshio14@gmail.com', password: '1401891'
yudji_oliveira = Person.create name: 'Yudji Nakaema Oliveira', email: 'yudji.nkm@hotmail.com', password: '160161X'
...
gabriel_silva = Person.create name: 'Gabriel Catice da Silva', email: 'gabriel.silva@email.com', password: '1600354'
isabella_silva = Person.create name: 'Isabella Cristina Gomes da Silva', email: 'isabella.silva@email.com', password: '1504045'
joyce_trindade = Person.create name: 'Joyce Nathalia de Souza Trindade', email: 'joyce.trindade@email.com', password: '1600389'
...
monica_pelicano = Person.create name: 'Monica Lourenco Gomes Pelicano', email: 'monica.pelicano@email.com', password: '1600591'
